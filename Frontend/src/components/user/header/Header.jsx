  ...
  return (
    ...
    <header className="header-area style-1">
        <div className="header-logo">
            						<a href="#" title="Spinner">
															<img className="img-fluid" src="/assets/img/header1-logo.svg" alt="Spinner" /></a>
										        </div>
        ...
        <div className="main-nav">
            ...
            <div className="main-nav-wrapper"><ul id="menu-main-menu" className="ul"><li id="menu-item-39" className="menu-item menu-item-type-custom menu-item-object-custom current-menu-item current_page_item menu-item-home current-menu-ancestor current-menu-parent menu-item-has-children menu-item-39"><a href="/" aria-current="page">Home</a>

</li>
<li id="menu-item-53" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-53"><a href="/about.html">About Us</a>

</li>
<li id="menu-item-56" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-56"><a href="#">Services</a>

</li>
<li id="menu-item-57" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-57"><a href="#">Projects</a>

</li>
<li id="menu-item-58" className="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-58"><a href="/blog.html">Blog</a>

</li>
<li id="menu-item-2109" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2109"><a href="/contact.html">Contact Us</a><i className="bi bi-chevron-down"></i></li>
</ul>
                    ...
                    <h5 className="text-white mb-0">MENU</h5>
                            ...
                            <div className="hotline-info">
                                ...
                                <h6><a href="mailto:info@example.com">info@example.com</a></h6>
                                                                ...
                                                                <div className="eg-btn btn--primary">
                            <a className="header-btn" href="#">LET&#039;S TALK</a>
                        </div>
                                                </div>
            </header>
